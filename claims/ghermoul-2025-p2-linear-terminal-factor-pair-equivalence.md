...
取 \(s=1\)，则 \(E=R+1=4y\)。在定理的因子对中，这强制

\[
Q=\frac{4CH}{R+1}=\frac{CH}{y}. \tag{9}
\]

因此固定这张 \(p_2(x,y,z)\) 正规形的 \(p-1\) 线性终端桥存在，当且仅当
...
\[
C\equiv-x\pmod y,
\qquad H=z(4y-1)-1\equiv-(z+1)\pmod y,
\]

故 (10) 等价于简洁的坐标判据

\[
\boxed{y\mid x(z+1).} \tag{11}
\]
...
所以它提供以 \(n=p-1\) 为源的 \(B=1\) Type I 终端桥。尤其，所有 \(y=1\) 的第二族形式自动属于该子族；这只说明此参数切片可终止，并不说明每个核心素数有 \(y=1\) 的第二族表示。
