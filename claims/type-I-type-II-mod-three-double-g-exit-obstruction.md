...
statement: >-
  ...
  x=636,d=8。更强地，双 G 素数 p=118801 完整避开 gaps 3,7,...,55，
  其首个证书为 gap 59 的 Type II x=29715,d=21。因此 q=1 G 不能仅由
  R=3 伴随图表、(3p+1)/4 递降或固定到 gap 55 的小缺口扇全称闭合。
...
三个出现的素数均为 \(1\pmod3\)，所以这仍是双 G。下表列出每个自然 gap
\(m<59\) 的 \(x=(p+m)/4\) 分解以及 Type I/II 所需的平方除子剩余
\((t_{\rm I},t_{\rm II})=(-px,-x)\pmod m\)：

| \(m\) | \(x\) 的素因子分解 | \((t_{\rm I},t_{\rm II})\) |
|---:|---|---|
| 3 | \(7\cdot4243\) | \((2,2)\) |
| 7 | \(2\cdot14851\) | \((3,6)\) |
| 11 | \(3\cdot9901\) | \((8,8)\) |
| 15 | \(2^3\cdot47\cdot79\) | \((11,11)\) |
| 19 | \(5\cdot13\cdot457\) | \((10,11)\) |
| 23 | \(2\cdot3\cdot4951\) | \((14,10)\) |
| 27 | \(61\cdot487\) | \((20,20)\) |
| 31 | \(2^2\cdot7\cdot1061\) | \((3,21)\) |
| 35 | \(3^2\cdot3301\) | \((31,6)\) |
| 39 | \(2\cdot5\cdot2971\) | \((17,8)\) |
| 43 | \(11\cdot37\cdot73\) | \((27,2)\) |
| 47 | \(2^4\cdot3\cdot619\) | \((26,39)\) |
| 51 | \(43\cdot691\) | \((32,20)\) |
| 55 | \(2\cdot83\cdot179\) | \((41,41)\) |

对每一行，\(x^2\) 的完整除子剩余谱都避开 \(t_{\rm I}\)，而不大于 \(x\) 的
完整除子谱也避开 \(t_{\rm II}\)。这逐项排除所有 Type I/II 证书，故不是只排除
某个固定除子菜单。

在下一 gap \(m=59\)，有

\[
x=29715=3\cdot5\cdot7\cdot283,
\qquad
d=21,
\qquad
x+d=29736=59\cdot504.
\tag{13}
\]

所以 \(d\mid x^2\)、\(d\le x\)、\(59\mid x+d\)，给出 Type II terminal
...
这个 gap 也有真实两尾递降回执。令 \((A,B,C,K)=(1,1415,21,24)\)，则
\(A+B=59K\)，并且

\[
\frac4{1981}=\frac1{29715}+\frac1{504}+\frac1{713160}
\longmapsto
\frac4{118801}=\frac1{29715}+\frac1{59875704}+\frac1{84724121160}.
\tag{15}
\]

这里 \(1981=(p+59)/60<p\)。因此该点不是猜想反例，却严格否定任何只依靠
gaps \(\le55\) 的双 G 全称出口。
