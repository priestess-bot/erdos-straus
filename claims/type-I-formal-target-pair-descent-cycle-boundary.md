...
后续的核心同余审计进一步缩小了周期风险：\(R\equiv3\pmod8\) 时核心一层
\(K\) 支撑图为空；对 \(R\equiv7\pmod8\)、\(R\le9999\) 的通用放大图，435 个简单
周期全部由其平方自由坐标支撑直接产生中心盒命中。这个有限结果及非核心反例见
[核心一层形式周期的奇偶约化与 radical cube 命中边界](type-I-core-formal-cycle-radical-cube-boundary.md)。
