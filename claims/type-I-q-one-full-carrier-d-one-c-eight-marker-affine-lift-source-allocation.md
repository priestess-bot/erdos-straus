...
statement: >-
  ...
  因而 n 偶、p=49 (mod 96)、p rho=-1 (mod 64)，并且
...
那么 (S_{\rm odd},L_0,E\mid M/47)。由 (5)、(17)--(18)，得到不是启发式而是
逐因子强制的分配：
...
剩余候选被压到 (16) 的两条 \(\rho\) 射线及 (20)--(21) 的 source 分配。它尚未证明

- (q\mid V) 与这些射线没有交；
- 任一剩余射线产生 Type I/II 短证书；
- 或 source/path、typed guards 和 E1--E5 可升级为 (n<p) 的递降。

下一步必须把 (q\mid V) 的四次因子条件同 (20)--(21) 的分配联立；只重复局部
