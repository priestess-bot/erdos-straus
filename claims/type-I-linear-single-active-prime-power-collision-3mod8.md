...
$$
\gcd(U,V)\mid |a-s|. \tag{6a}
$$

核心素数条件排除了 \(a=s\)：若 \(a=s>1\)，则
\(p=a(2+aR)\) 合成；若 \(a=s=1\)，则
\(p=R+2\equiv5\pmod8\)，与 \(p\equiv1\pmod8\) 矛盾。因此在 \(a\) 奇的分支中还有

$$
\boxed{q^{e/2}\mid |a-s|.} \tag{6b}
$$
