...
479 态。四个状态局部残余分别由 gap \(43,19,19,15\) 的独立 Type I 证书闭合，故该
冻结样本最终 483/483 有直接证书；固定小缺口只是有限补丁，不是全称选择规则。
...
E4，下一步应转向非自然标记提升、改变保留分母的提升公式，或合法换支撑状态。

四个残余的规范二进候选还显示一个可研究的内部结构：其因子对中的 \(B\) 都可取为
\(\Psi_0=1\) 缺陷素数集合的非空子集乘积，\(A\) 则来自互素补支撑。这可作为候选选择
引理的原型，但在建立非自然标记解与全域提升前仍只属于分析证据。

复现脚本与结果 SHA-256 分别为
`fbd6bec0493a0216c68c2e96352f6e2e67b1bca455d55799c6f29f489968a7b5`、
`6cac496237cf87359a7e915a3f824a3837fe1ced070e06a4edff191aa773978c`。严格主张卡见
