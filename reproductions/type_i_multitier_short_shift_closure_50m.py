#!/usr/bin/env python3
"""Compose the fifty-million Type I p-1 and short-shift finite selector tiers."""
...
DYADIC = ROOT / "reproductions" / "type-i-dyadic-pminusone-profile-50m-results.json"
MENU = ROOT / "reproductions" / "type-i-pminusone-b12-menu-profile-50m-results.json"
LOW_E = ROOT / "reproductions" / "type-i-pminusone-low-e1m-all-b-joint-residual-profile-50m-results.json"
SHIFTED_MENU = ROOT / "reproductions" / "type-i-shifted-source-b1-menu-profile-50m-results.json"
SHORT_SHIFT = ROOT / "reproductions" / "type-i-short-shift-low-e-b7-profile-50m-results.json"
DEFAULT_OUTPUT = ROOT / "reproductions" / "type-i-multitier-short-shift-closure-50m-results.json"
...
def run_profile(
    ...
    """Apply five disjoint finite selector stages to every stored fifty-million core prime."""
    ...
    if limits != {50_000_017}:
        raise AssertionError("input profiles do not share the stated fifty-million prefix")
    ...
    return {
        "arithmetic": (
            ...
            "and the eight-shift dynamic-E selector with B<=7"
        ),
        "scope_note": (
