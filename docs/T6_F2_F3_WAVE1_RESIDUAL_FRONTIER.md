...
| F2 post-G/H4/c8 | q1 root-to-final slice runs through runtime, preempts one low class and contracts the other to C=9 high overflow, but high final targets have no route | E1/E3 |
